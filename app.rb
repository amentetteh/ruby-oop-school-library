...
require_relative './file_storage_manager'

require 'json'

class App
  def initialize
    @books = FileStorageManager.load_data('books')

    @people = FileStorageManager.load_data('people')

    @rentals = FileStorageManager.load_data('rentals')
  ...
  def leave
    FileStorageManager.save_data('books', @books)

    FileStorageManager.save_data('people', @people)

    FileStorageManager.save_data('rentals', @rentals)
